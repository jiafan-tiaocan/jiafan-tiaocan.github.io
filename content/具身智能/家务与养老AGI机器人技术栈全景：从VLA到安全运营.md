...
> [!note] 证据边界
> - 信息核验截点为 **2026-07-28**。“最新”只指该日期前公开可核验的信息。
> - 公司视频和技术博客证明“系统在所示条件下做到过”，不自动证明量产、泛化或第三方可复现。
> - Sunday、Figure、1X 等指标主要来自公司自评；ElliQ 数据由纽约州老龄办公室托管的项目报告发布，但仍以匿名使用数据和用户自报为主，不等同于随机对照临床试验。
> - 不同机器人、任务、成功标准和人工介入规则不同，本文不把成功率横向排成厂商榜单。

阅读路线：只想看选型，读“热度表”和“六种企业路线”；想理解原理，读“八层技术栈”；做养老产品，则直接看“为什么养老栈必须另加四层安全闭环”。
