...
| [[2026-06-09 Anthropic Claude Fable 5]] | 2026-06-09；07-01 恢复全球服务 | 从 Opus 级进入 Mythos 级的长程自主工作；以 Fable 安全配置和 Opus 4.8 fallback 控制高风险能力 | 能力评价很强，但每百万 token 输入 10 美元、输出 50 美元的价格，fallback 混入评测、短暂停服及更严格分类器的误拒绝成为同等重要的话题 | 把 fallback、拒绝率和成本固定后，纯模型的长程成功率还剩多少 |
