...
如果只想获得直觉，读“幂律究竟说了什么”“固定算力怎样推导最优解”和“为什么 Chinchilla 改写了答案”三节即可。

如果关心训练设计，继续读联合的 $L(N,D)$、学习曲线与最后的实践清单。

如果关心 scaling law 的边界，重点看论文 Figure 15 和最后的五点思考。那里比“更大模型”更接近这篇论文今天仍有价值的部分。
