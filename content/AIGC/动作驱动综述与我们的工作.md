...
> [!note] 证据边界
> - 项目实践发生在 2024 年 7 月至 2025 年 7 月；两份归档材料在 2026 年 7 月重建，公开论文与 MimicMotion 官方仓库在 2026-07-30 复核。不要把后来的公开能力倒推为项目当时已经拥有。
...
这是一篇长文。只想理解路线决策，可以读第 1、6、10 节；想深挖 MimicMotion，直接读第 2.2-2.8 节；想理解语音驱动、多条件统一与局部口型监督，读第 3-5 节；想接手项目，则重点读第 7-9 节。
...
第一层是**软引导**：不再用固定阈值把低置信关键点直接删掉，而是用亮度连续编码置信度。遮挡、运动模糊或重复检测产生的可疑骨架仍然存在，但影响更小；模型还能从“这个肢体不确定”本身获得可见性线索。
