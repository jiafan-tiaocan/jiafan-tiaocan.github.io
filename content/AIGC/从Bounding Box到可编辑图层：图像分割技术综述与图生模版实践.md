...
- **项目方案与模型分工**：阅读第 4 节，了解 YOLOv7、OCR、Qwen2.5-VL、Grounding DINO、SAM 2 与 Inpainting 链路的职责。
- **概念边界与技术演进**：阅读任务边界、第 1 节和第 2 节，区分检测、分割、抠图、背景修复与可编辑图层。
- **生产实现与质量控制**：阅读第 5 至第 8 节，关注系统契约、代码骨架、评测门禁和回归测试。
