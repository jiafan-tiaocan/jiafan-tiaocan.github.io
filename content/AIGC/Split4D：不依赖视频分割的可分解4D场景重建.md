...
![传统路线与 Split4D 的责任转移](assets/split4d/split4d-responsibility-shift.svg)
...
![Split4D 的三类一致性约束](assets/split4d/split4d-three-consistencies.svg)
...
![随机抽帧与流式学习的差异](assets/split4d/split4d-streaming-relay.svg)
...
![Split4D 组件消融与 mIoU 下降](assets/split4d/split4d-ablation-evidence.svg)
